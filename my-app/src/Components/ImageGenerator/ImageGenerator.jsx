...
function ImageGenerator({ onGenerateImage }) {
  ...
  const initialApiType = queryParams.get("apiType") || "text-to-image"; // Default to "sketch-to-image"
            ...
            {iconsbottom.map((iconUrl, index) => (
              <div key={index} style={{ width: '100%' }}>
                ...
                >
                  ...
                  <span className={styles.toolName}>{bottomToolNames[index]}</span>
                </button>
