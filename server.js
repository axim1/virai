...
app.post('/image-callback', async (req, res) => {
  try {
    ...
    const response = await axios.get(`https://qs5hqcgtc0tje8-8000.proxy.runpod.net/getimage/${imageUuid}`, {
      params: {
        delete: true,
        type: 'PNG',
        base64_c: false,
...
app.post('/sketch-to-image', upload.single('sketch_image'), async (req, res) => {
  try {
    ...
    try {
      sketch2imageResponse = await axios.post('https://qs5hqcgtc0tje8-8000.proxy.runpod.net/sketch2image', form, {
        headers: {
          ...form.getHeaders(),
        },
      });
...
app.post('/text-to-image',upload.none(), async (req, res) => {
  try {
    ...
    form.append('scheduler', 'Default');    
    try {
      sketch2imageResponse = await axios.post('https://qs5hqcgtc0tje8-8000.proxy.runpod.net/text2image', form, {
        headers: {
          ...form.getHeaders(),
        },
      });
...
app.post('/text-callback', async (req, res) => {
  try {
    ...
    const response = await axios.get(`https://qs5hqcgtc0tje8-8000.proxy.runpod.net/gettext/${textUuid}`, {
      headers: {
        'accept': 'application/json'
      }});
...
app.post('/prompt-enhancer', upload.none(), async (req, res) => {
  try {
    ...
    const response = await axios.post('https://qs5hqcgtc0tje8-8000.proxy.runpod.net/promptenhancer', form, {
      headers: {
        ...form.getHeaders(),
      },
    });
